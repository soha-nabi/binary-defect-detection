...
Overview:
This project implements a binary surface defect detection system using deep learning and explainable AI techniques. The model classifies steel surface images as defect vs non-defect and generates visual explanations using Grad-CAM.
...
project/
 ...
 └── outputs/
Summary
This project demonstrates an end-to-end explainable defect detection pipeline using transfer learning and Grad-CAM. The system provides accurate predictions along with interpreable visual evidence, making it suitable for industrial quality inspection applications.